            ...
            {selectedData.data.map(tender => (
              <tr key={tender.id}>
                ...
                <td>
                  ...
                  <button className='mx-4' onClick={() => handleUpdateTenderClick(tender)}>Update</button>
                  <button onClick={() => handleDeleteTender(tender)} className='mx-4'>Delete</button>
                </td>
              </tr>
            ))}
            </tbody>
            ...
            <tbody>
              {selectedData.data.map(job => (
                <tr key={job.id}>
                  ...
                  <td>{job.category}</td>
                  <td>
                    <button className='mx-4' onClick={() => handleViewJob(job)}>View</button>
                    <button className='mx-4' onClick={() => handleDeleteJob(job)}>Delete</button>
                  </td>
                </tr>
              ))}
            </tbody>
            ...
            {Array.isArray(postCareerFormData.requirements) && postCareerFormData.requirements.map((requirement, index) => (
              <div key={index} className="array-input-group">
                <input
                  ...
                  required
                />
                <button type="button" className="mx-4 py-1" onClick={() => handleRemoveItem(index, 'requirements')}>Remove</button>
              </div>
            ))}
            <button type="button" className="mx-4 py-1" onClick={() => handleAddItem('requirements')}>Add Requirement</button>
          </div>
            ...
            {Array.isArray(postCareerFormData.benefits) && postCareerFormData.benefits.map((benefit, index) => (
              <div key={index} className="array-input-group">
                <input
                  ...
                  required
                />
                <button type="button" className="m-3" onClick={() => handleRemoveItem(index, 'benefits')}>Remove</button>
              </div>
            ))}
            <button type="button" className="m-2" onClick={() => handleAddItem('benefits')}>Add Benefit</button>
          </div>
